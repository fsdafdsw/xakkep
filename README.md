...
| Поле | Значение |
| --- | --- |
| Автор | Вячеслав Шушурихин |
| Роль | Профессиональный редактор и вайб-кодер |
| Фокус | Текст, автоматизация, аналитика, продуктовый код |
| Связь | [t.me/shushurikhin](https://t.me/shushurikhin) |
| Формат | Открыт к новым проектам, коллаборациям и предложениям |
