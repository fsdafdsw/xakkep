...
def _geopolitical_repricing_predictor(market, question_text):
    ...
    return {
        ...
        "components": {
            ...
            "question_geo_keywords": geo_context.get("question_geo_keywords") or [],
            "action_keywords": geo_context["action_keywords"],
            "institution_keywords": geo_context["institution_keywords"],
            "release_context_keywords": geo_context.get("release_context_keywords") or [],
            "release_figure_keywords": geo_context.get("release_figure_keywords") or [],
