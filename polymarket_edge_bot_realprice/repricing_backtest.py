...
def analyze_repricing(rows, args):
    ...
    for idx, row in enumerate(filtered, start=1):
        ...
        analysis = {
            ...
            "repricing_lane_key": rebuilt_repricing.get("lane_key") or row.get("repricing_lane_key"),
            "repricing_lane_label": rebuilt_repricing.get("lane_label") or row.get("repricing_lane_label"),
            "repricing_lane_prior": rebuilt_repricing.get("lane_prior", row.get("repricing_lane_prior")),
