...
def build_snapshot_row(candidate, decision, context):
    ...
    return {
        ...
        "repricing_urgency_phase": repricing.get("urgency_phase"),
        "repricing_urgency_decay_rate": repricing.get("urgency_decay_rate"),
        "repricing_urgency_edge_multiplier": repricing.get("urgency_edge_multiplier"),
